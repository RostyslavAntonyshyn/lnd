...
type ResolveRequest struct {
	...
	HeightNow uint32 `protobuf:"varint,3,opt,name=height_now" json:"height_now,omitempty"`
...
func (*ResolveRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{107} }
...
func (*ResolveResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{108} }
...
func init() {
	...
	proto.RegisterType((*ResolveRequest)(nil), "lnrpc.ResolveRequest")
	proto.RegisterType((*ResolveResponse)(nil), "lnrpc.ResolveResponse")
...
// Client API for HashResolver service

type HashResolverClient interface {
...
type hashResolverClient struct {
	cc *grpc.ClientConn
}

func NewHashResolverClient(cc *grpc.ClientConn) HashResolverClient {
	return &hashResolverClient{cc}
}

func (c *hashResolverClient) ResolveHash(ctx context.Context, in *ResolveRequest, opts ...grpc.CallOption) (*ResolveResponse, error) {
	out := new(ResolveResponse)
	err := grpc.Invoke(ctx, "/lnrpc.HashResolver/ResolveHash", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for HashResolver service

type HashResolverServer interface {
	// ResolveHash is used by LND to request translation of Rhash to a pre-image.
	// the resolver may return the preimage and error indicating that there is no
	// such hash/deal
...
func RegisterHashResolverServer(s *grpc.Server, srv HashResolverServer) {
	s.RegisterService(&_HashResolver_serviceDesc, srv)
}

func _HashResolver_ResolveHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HashResolverServer).ResolveHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.HashResolver/ResolveHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HashResolverServer).ResolveHash(ctx, req.(*ResolveRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _HashResolver_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lnrpc.HashResolver",
	HandlerType: (*HashResolverServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ResolveHash",
			Handler:    _HashResolver_ResolveHash_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
